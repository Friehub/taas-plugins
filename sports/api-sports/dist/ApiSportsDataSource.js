...
exports.ApiSportsDataSource = void 0;
 ...
 */
class ApiSportsDataSource extends discovery_1.SovereignAdapter {
    constructor(config = {}) {
        super({
            ...config,
            id: 'api-sports',
    ...
    async fetchData(params, signal) {
        ...
        if (method === 'sports.football.score') {
            ...
            if (!f)
                throw new Error(`[ApiSports] Fixture ${fixtureId} not found.`);
            return {
        ...
        if (method === 'sports.basketball.score') {
            ...
            if (!g)
                throw new Error(`[ApiSports] Game ${gameId} not found.`);
            return {
                match_id: g.id,
        ...
        if (method === 'sports.football.statistics') {
            ...
            if (!stats || stats.length === 0)
                throw new Error(`[ApiSports] Statistics for fixture ${fixtureId} not found.`);
            // Normalize array of stats objects to flat object
            const normalizeStats = (teamStats) => {
                const map = {};
                teamStats.forEach(s => {
...
exports.ApiSportsDataSource = ApiSportsDataSource;
